...
export default function Home() {
  return (
    <>
      <Head>
        <title>AgroTracking | Home</title>
        <meta
          name="description"
          content="A web application for managing and recording technical field visits conducted by students and instructors."
        />
      </Head>
      <main className="p-6 min-h-screen flex flex-col items-center justify-center bg-green-50 geistSans">
        <h1
